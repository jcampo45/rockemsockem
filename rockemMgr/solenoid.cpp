...
int main(int argc, char **argv){
  ...
  BlackLib::BlackGPIO solenoidBR(BlackLib::GPIO_2, BlackLib::output, BlackLib::FastMode);
  BlackLib::BlackGPIO solenoidBL(BlackLib::GPIO_15, BlackLib::output, BlackLib::FastMode);
  BlackLib::BlackGPIO solenoidBH(BlackLib::GPIO_14, BlackLib::output, BlackLib::FastMode);
